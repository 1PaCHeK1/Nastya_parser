...
def upgrade() -> None:
    ...
    op.alter_column(
        "favoriteword", "user_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "favoriteword", "word_id", existing_type=sa.INTEGER(), nullable=False
    )
    ...
    op.alter_column(
        "post", "publish_date", existing_type=postgresql.TIMESTAMP(), nullable=False
    )
    op.alter_column(
        "quizquestions", "question", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "quizquestions", "theme_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "quizquestions", "answer_one", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "quizquestions", "answer_two", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "quizquestions", "answer_three", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "quizquestions",
        "right_answer",
    ...
    op.alter_column(
        "translates", "from_language_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "translates", "to_language_id", existing_type=sa.INTEGER(), nullable=False
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "translates", "to_language_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "translates", "from_language_id", existing_type=sa.INTEGER(), nullable=True
    )
    ...
    op.alter_column(
        "quizquestions", "answer_three", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "quizquestions", "answer_two", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "quizquestions", "answer_one", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "quizquestions", "theme_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "quizquestions", "question", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "post", "publish_date", existing_type=postgresql.TIMESTAMP(), nullable=True
    )
    ...
    op.alter_column(
        "favoriteword", "word_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "favoriteword", "user_id", existing_type=sa.INTEGER(), nullable=True
    )
    # ### end Alembic commands ###
